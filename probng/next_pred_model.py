...
files = ['/content/bg-next_pred.csv','ca-next_pred.csv','/content/en-next_pred.csv',
         '/content/fr-next_pred.csv','/content/hyw-next_pred.csv',
         '/content/la-next_pred.csv',
          '/content/ru-next_pred.csv', '/content/cs-next_pred.csv',
         '/content/tr-next_pred.csv','/content/sr-next_pred.csv']
