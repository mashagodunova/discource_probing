...
def acc(file, tokenizer_name, model_name):
    ...
    texts1 = (train_tr['sent_1'].map(str) +
               ...
               train_tr['sent_3'].map(str) + '.'+ train_tr['sent_4'].map(str) + '.'+ train_tr['sent_5'].map(str))
...
files = ['/content/bg-cloze_test.csv','ca-cloze_test.csv','/content/en-cloze_test.csv',
         '/content/fr-cloze_test.csv','/content/hyw-cloze_test.csv',
         '/content/la-cloze_test.csv',
          '/content/ru-cloze_test.csv', '/content/cs-cloze_test.csv',
         '/content/tr-cloze_test.csv','/content/sr-cloze_test.csv']
