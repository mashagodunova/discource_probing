...
files = ['/content/bg-sent_posit.csv','ca-sent_posit.csv','/content/en-sent_posit.csv',
         '/content/fr-sent_posit.csv','/content/hyw-sent_posit.csv',
         '/content/la-sent_posit.csv',
          '/content/ru-sent_posit.csv', '/content/cs-sent_posit.csv',
         '/content/tr-sent_posit.csv','/content/sr-sent_posit.csv']
