...
def acc(file, tokenizer_name, model_name):
    ...
    #decoder_input_ids, input_ids for mgpt
    with torch.no_grad():
...
files = ['/content/bg-bin_so.csv','ca-bin_so.csv','/content/en-bin_so.csv',
         '/content/fr-bin_so.csv','/content/hyw-bin_so.csv',
         '/content/la-bin_so.csv',
          '/content/ru-bin_so.csv', '/content/cs-bin_so.csv',
         '/content/tr-bin_so.csv','/content/sr-bin_so.csv']
